...
# Add both to sys.path to ensure modules can be found
for d in [current_dir, root_dir]:
    if d not in sys.path:
        sys.path.append(d)

logger.info(f"Startup - current_dir: {current_dir}")
...
if os.path.exists(template_dir):
    logger.info(f"Templates in dir: {os.listdir(template_dir)}")
else:
