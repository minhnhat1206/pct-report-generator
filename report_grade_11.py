...
# Lists and Class Objects Grade 11
classes = ['11E1','11E2','11E3','11E4','11V1','11V2','11V3','11V4','11V5','11V6']
class_objects = {cls: SchoolClass(cls) for cls in classes}

class_objects['11E1'].add_session('Session 1', Session('1, 2', 'Vĩ Văn'))
class_objects['11E1'].add_session('Session 2', Session('1, 2', 'Tim (Thịnh)'))
class_objects['11E1'].add_session('Session 3', Session('1, 2', 'Kim Ngân'))

class_objects['11E2'].add_session('Session 1', Session('1, 2', 'Kim Ngân'))
class_objects['11E2'].add_session('Session 2', Session('1, 2', 'Trúc Quỳnh'))
class_objects['11E2'].add_session('Session 3', Session('1, 2', 'Amora (Tâm)'))

class_objects['11E3'].add_session('Session 1', Session('1, 2', 'Văn Trí'))
class_objects['11E3'].add_session('Session 2', Session('1, 2', 'Tim (Thịnh)'))
class_objects['11E3'].add_session('Session 3', Session('1, 2', 'Hương'))

class_objects['11E4'].add_session('Session 1', Session('3, 4', 'Vĩ Văn')) 
class_objects['11E4'].add_session('Session 2', Session('3, 4', 'Thị Quyên'))
class_objects['11E4'].add_session('Session 3', Session('3, 4', 'Amora (Tâm)'))

class_objects['11V1'].add_session('Session 1', Session('1, 2', 'Tim (Tú)'))
class_objects['11V1'].add_session('Session 2', Session('1, 2', 'Hương'))
class_objects['11V1'].add_session('Session 3', Session('1, 2', 'Linh'))

class_objects['11V2'].add_session('Session 1', Session('1, 2', 'Xuân Lộc'))
class_objects['11V2'].add_session('Session 2', Session('1, 2', 'Quyên'))
class_objects['11V2'].add_session('Session 3', Session('1, 2', 'Edward (Nhi)'))

class_objects['11V3'].add_session('Session 1', Session('1, 2', 'Văn Trí'))
class_objects['11V3'].add_session('Session 2', Session('1, 2', 'Minh Quang'))
class_objects['11V3'].add_session('Session 3', Session('1, 2', 'Rolando (Nhi)'))

class_objects['11V4'].add_session('Session 1', Session('1, 2', 'Tim (Tú)'))
class_objects['11V4'].add_session('Session 2', Session('1, 2', 'Kim Ngân'))
class_objects['11V4'].add_session('Session 3', Session('1, 2', 'Minh Quang'))

class_objects['11V5'].add_session('Session 1', Session('3, 4', 'Kim Ngân '))
class_objects['11V5'].add_session('Session 2', Session('3, 4', 'Trúc Quỳnh'))
class_objects['11V5'].add_session('Session 3', Session('3, 4', 'Rolando (Quyên)'))

class_objects['11V6'].add_session('Session 1', Session('3, 4', 'Xuân Lộc'))
class_objects['11V6'].add_session('Session 2', Session('3, 4', 'Linh'))
class_objects['11V6'].add_session('Session 3', Session('3, 4', 'Edward (Nhi)'))
...
def create_report(class_name, current_week, vstep_lesson_num, ielts_lesson_num, data, data_feedback, output_dir, 
                  course_vstep="Practical English A2-B2", course_ielts="Practical English B2 & IELTS A2-B1",
    ...
    def check_warning_time(x):
        try:
            if isinstance(x, str) and 'phút' in x:
                val = float(x.split()[0])
                return val < 10 and val > 0 # Ignore 0 as it might be no study? User logic said < 10. User snippet just < 10.
            return False
        except:
            return False

    # User snippet simplified check: float(x.split()[0]) < 10. '0 phút' is < 10.
...
def generate_grade_11_reports(current_week, vstep_lesson_num, ielts_lesson_num, data_file_path, output_dir=None, 
                              target_classes_list=None, course_vstep="Practical English A2-B2", course_ielts="Practical English B2 & IELTS A2-B1",
                              total_ielts=54, total_vstep=52, timesheet_path=None):
    if output_dir is None:
        output_dir = os.path.join(BASE_DIR, 'Grade_11', f'Grade_11_Week {current_week}')
    ...
    if not target_classes_list:
        target_classes_list = classes  # Fallback to global if needed

    # Load Data
    excel_file = pd.read_excel(data_file_path)
    
    # Clean and Process
    data = clean_data(excel_file, list_11)
